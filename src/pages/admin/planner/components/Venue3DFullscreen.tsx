  ...
  return (
    <div className="fixed inset-0 z-[99998] bg-black">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-3 bg-gradient-to-b from-black/70 via-black/30 to-transparent pointer-events-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          <button
            ...
            className="flex items-center gap-1.5 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white text-[11px] font-semibold px-3 h-10 sm:h-9 rounded-xl border border-white/10 transition-all duration-200 active:scale-95"
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 sm:w-9 sm:h-9 flex items-center justify-center bg-white/10 hover:bg-red-500/80 backdrop-blur-md text-white rounded-xl border border-white/10 transition-all duration-200 active:scale-95"
      ...
      <button
        ...
        className={`absolute top-14 z-20 w-10 h-10 sm:w-8 sm:h-8 flex items-center justify-center bg-black/60 backdrop-blur-md text-white/60 hover:text-white rounded-lg border border-white/10 transition-all duration-300 pointer-events-auto ${showPanel ? "right-[240px] sm:right-[220px]" : "right-3"}`}
